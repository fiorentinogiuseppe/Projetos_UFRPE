  ...
  implements Stemmer, TechnicalInformationHandler
{
  ...
  public TechnicalInformation getTechnicalInformation()
  {
    ...
    result.setValue(TechnicalInformation.Field.AUTHOR, "Julie Beth Lovins");
    result.setValue(TechnicalInformation.Field.YEAR, "1968");
    result.setValue(TechnicalInformation.Field.TITLE, "Development of a stemming algorithm");
    result.setValue(TechnicalInformation.Field.JOURNAL, "Mechanical Translation and Computational Linguistics");
    result.setValue(TechnicalInformation.Field.VOLUME, "11");
    result.setValue(TechnicalInformation.Field.PAGES, "22-31");
      ...
      if (length - el > 1) {
        ...
        if (conditionCode != null) {
          ...
          case 'b': 
            ...
            else if ((length - el > 2) && ((word.charAt(length - el - 1) != 't') || (word.charAt(length - el - 2) != 'e') || (word.charAt(length - el - 3) != 'm')) && ((length - el < 4) || (word.charAt(length - el - 1) != 't') || (word.charAt(length - el - 2) != 's') || (word.charAt(length - el - 3) != 'y') || (word.charAt(length - el - 4) != 'r')))
            {
          ...
          case 'c': 
            ...
            break;
          case '[': case '\\': case ']': case '^': case '_': case '`': default: 
  ...
  private String recodeEnding(String word)
  {
    ...
    if ((word.endsWith("ul")) && (
      (lastPos - 2 < 0) || ((word.charAt(lastPos - 2) != 'a') && (word.charAt(lastPos - 2) != 'i') && (word.charAt(lastPos - 2) != 'o'))))
    {
    ...
    if ((word.endsWith("end")) && (
      (lastPos - 3 < 0) || (word.charAt(lastPos - 3) != 's')))
    {
    ...
    if ((word.endsWith("her")) && (
      (lastPos - 3 < 0) || ((word.charAt(lastPos - 3) != 'p') && (word.charAt(lastPos - 3) != 't'))))
    {
    ...
    if ((word.endsWith("end")) && (
      (lastPos - 3 < 0) || (word.charAt(lastPos - 3) != 'm')))
    {
      word = word.substring(0, lastPos - 2).concat("ens");
    }
    ...
    if ((word.endsWith("et")) && (
      (lastPos - 2 < 0) || (word.charAt(lastPos - 2) != 'n')))
    {
