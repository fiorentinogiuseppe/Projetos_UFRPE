  ...
  implements WeightedInstancesHandler, TechnicalInformationHandler
{
    ...
    implements Serializable
  {
      ...
      throws Exception
    {
      ...
      else
      {
        ...
        for (int i = 0; i < numFolds; i++) {
          ...
          BinarySMO smo = new BinarySMO(SMO.this);
          smo.setKernel(Kernel.makeCopy(m_kernel));
    ...
    public double SVMOutput(int index, Instance inst)
      throws Exception
    {
      double result = 0.0D;
      int p1;
      ...
      throws Exception
    {
      ...
      if (a2 > C2 - SMO.m_Del * C2) {
        a2 = C2;
      } else if (a2 <= SMO.m_Del * C2) {
        a2 = 0.0D;
      }
      ...
      if (a1 > C1 - SMO.m_Del * C1) {
        a1 = C1;
      } else if (a1 <= SMO.m_Del * C1) {
        a1 = 0.0D;
      }
