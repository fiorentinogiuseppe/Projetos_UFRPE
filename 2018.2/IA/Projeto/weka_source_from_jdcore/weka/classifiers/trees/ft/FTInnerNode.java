  ...
  extends FTtree
{
    ...
    throws Exception
  {
    ...
    boolean grow;
    boolean grow; if (m_numInstances > m_minNumInstances) {
    ...
    if (grow)
    {
      ...
      for (int i = 0; i < m_sons.length; i++) {
        m_sons[i] = new FTInnerNode(m_errorOnProbabilities, m_fixedNumIterations, m_minNumInstances, getWeightTrimBeta(), getUseAIC());
